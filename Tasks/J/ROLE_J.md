...
- Config와 공용 플레이어·아이템 Blueprint를 직접 수정하지 않습니다.
- C++는 얼음 빙하·눈섬 맵 전용 Actor·Component처럼 J Task에서 선점한 맵 환경 로직에 한해 수정할 수 있습니다.
- Level Blueprint에서 서버 판정과 공용 경기 상태를 집중 구현하지 않고, 맵 전용 Actor·Component·Blueprint로 분리합니다.
