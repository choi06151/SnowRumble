...
6. 눈숲속 환경 압박은 C가 제공한 공용 피해·경기 계약을 사용하고, Level Blueprint에 핵심 판정을 집중시키지 않습니다.
7. 대화에서 생긴 순서 변경·오류·추가 작업은 Codex가 `PLAN_S.md`와 관련 Task에 기록합니다.

## 금지와 인계

- Config와 공용 게임플레이 Blueprint를 직접 수정하지 않습니다.
- C++는 눈숲속 맵 전용 Actor·Component처럼 S Task에서 선점한 맵 환경 로직에 한해 수정할 수 있습니다.
