...
| --- | --- | --- | --- | --- |
| I-01 기존 기반 | C-01 | 모든 역할 | 재사용 파일·자산과 공용 소유권 | 예정 |
| I-02 세션·방 | C-02 | C-03, S-02 | 방 설정·검색·참가 상태와 요청 | 예정 |
| I-03 팀·대기방 | C-03 | C-04, C-08, S-03 | 랜덤 팀·준비·동수 시작 상태 | 예정 |
| I-04 랜덤 맵·로딩 | C-04 | C-05, S-04, S-10, J | 선택 맵·로딩 인원·시작 결과 | 예정 |
| I-05 얼음·사망 | C-06 | C-05, C-07, K-07, S-05, S-07 | 얼음 잔여시간·사망·관전·전멸 결과 | 예정 |
| I-06 플레이어 효과 | C-07 | K, S-07, S-09, S-10, J-02, J-04 | 피해·회복·무적·보정·부활·환경 요청 | 예정 |
| I-07 팀 등장·식별 | C-08 | S-05, S-10, J-02, J-04 | 팀 스폰·시작 제한·닉네임·팀 색 | 예정 |
| I-08 눈 전투 | C-09 | K-05, K-06, K-08, S-06 | 눈 제작·조준·충전·피격과 큰 눈 광역 결과 | 예정 |
| I-09 경기 흐름 | C-05 | K-02, K-09, S-11, 맵 담당 | 라운드 시간·승수·결과·금색 상자 시점 | 예정 |
| I-10 커스터마이징 | C-11 | S-01, S-02, S-08 | 외형 저장·복제·적용 상태 | 예정 |
| I-11 아이템 | K-01~K-10 | C-12, S-08, S-09, S-10, J | 아이템 상태·모델 요구·배치·UI 계약 | 예정 |
...
| G-02 공용 계약 | C-02~C-09와 C-11 중 소비 파트에 필요한 계약 완료 | 예정 |
